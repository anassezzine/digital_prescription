...
//   const patientNom = (document.getElementById('patient_nom') as HTMLInputElement).value;
//   const patientPrenom = (document.getElementById('patient_prenom') as HTMLInputElement).value;
...
//         (document.getElementById('patient_nom') as HTMLInputElement).value = '';
//         (document.getElementById('patient_prenom') as HTMLInputElement).value = '';
